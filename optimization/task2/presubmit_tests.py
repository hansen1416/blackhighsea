...
from task2_optimization import QuadraticOracle, create_log_reg_oracle
...
if __name__ == '__main__':
    ...
    testLBFGS.test_default()

    testLBFGS.test_tolerance()

    testLBFGS.test_max_iter()

    testLBFGS.test_memory_size()

    testLBFGS.test_line_search_options()

    testLBFGS.test_display()

    testLBFGS.test_quality()

    testLBFGS.test_history()